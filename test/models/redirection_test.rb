...
class RedirectionTest < ActiveSupport::TestCase
  ...
  def test_to_path_should_not_be_equal_to_from_path
    ...
    assert_includes @redirection.errors.full_messages, "To To URL can't be same as from URL"
  end
  ...
  def test_from_paths_should_be_unique
    ...
    assert_includes redirection_2.errors.full_messages, "From has already been taken"
  end
  ...
  def test_from_and_to_paths_should_not_form_loops
    ...
    assert_includes redirection_2.errors.full_messages,
  ...
  def test_from_path_shouldnot_contain_whitespaces
    ...
    assert_not @redirection.valid?
    assert_includes @redirection.errors.full_messages, "From URL cannot have whitespaces"
  end

  def test_to_path_shouldnot_contain_whitespaces
    @redirection.to = "/hello world"
    assert_not @redirection.valid?
    assert_includes @redirection.errors.full_messages, "To URL cannot have whitespaces"
  end
end
