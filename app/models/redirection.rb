...
class Redirection < ApplicationRecord
  ...
  validate :from_and_to_links_should_not_form_loops, :from_url_should_not_have_spaces, :to_url_should_not_have_spaces
  ...
  private
    ...
    def from_and_to_links_should_not_form_loops
